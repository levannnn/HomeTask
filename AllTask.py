...
mentor_reviewer_1.rate_hw_student(student_1, 'Django', 7)
...
print(f'Курсы студента {student_1.name} {student_1.surname}: ', ', '.join(
    student_1.courses_in_progress))
print(f'Курсы студента {student_2.name} {student_2.surname}: ', ', '.join(
    student_2.courses_in_progress))
...
courses_average_students(Student.students_list, 'Python')
